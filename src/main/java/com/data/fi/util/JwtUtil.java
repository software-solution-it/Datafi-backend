...
public class JwtUtil {
    ...
    private String createToken(Map<String, Object> claims, String subject) {
        return Jwts.builder()
                ...
                .signWith(SECRET_KEY) // Assinatura HMAC com chave secreta
                .compact();
    }
    ...
    private String jwtSecret = "sua-chave-secreta"; // Chave secreta para assinatura do token
